                ...
                <div class="card card-dashboard">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <i class="fa-solid fa-box icono text-success"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-dashboard">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <i class="fa-solid fa-users icono text-success"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-dashboard">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <i class="fa-solid fa-triangle-exclamation icono text-success"></i>
                            </div>
                        </div>
                    </div>
                </div>
